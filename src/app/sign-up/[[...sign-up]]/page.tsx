        ...
        <SignUp.Root>
          <SignUp.Step name="start" className='flex flex-col gap-4'>
            ...
            <div className="flex flex-col gap-4">
              ...
              <SignUp.Captcha />
              <SignUp.Action submit className='rounded-full p-2 text-white font-bold w-72 text-center bg-iconBlue'>
                Sign Up
              </SignUp.Action>
            </div>
          </SignUp.Step>
          ...
          <p className='text-xs w-72'>By SignUpg up, you agree to the <span className='text-iconBlue'>Terms of Service</span> and <span className='text-iconBlue'>Privacy Policy</span>, including <span className='text-iconBlue'>Cookie Use.</span></p>
        </SignUp.Root>
      </div>
    </div>
  )
