    ...
    <div className='h-screen flex items-center justify-between p-8'>
      ...
      <div className='w-full lg:w-1/2 flex flex-col gap-4'>
        ...
        <SignIn.Root>
          ...
          <Clerk.Connection name='apple' className='bg-white rounded-full p-2 text-black w-72 flex items-center justify-center gap-2 font-bold'>
            <svg viewBox="0 0 24 24" width={24} height={24}>
          ...
          <SignIn.Step name="start">
            <Clerk.Field name="identifier" className='flex flex-col gap-2'>
              <Clerk.Input placeholder='john@gmail.com' className='py-2 px-6 rounded-full text-black w-72 placeholder:text-sm' />
          ...
          <SignIn.Step name="verifications">
            <SignIn.Strategy name="password">
              <Clerk.Field name="password" className='flex flex-col gap-2'>
                <Clerk.Input type="password" placeholder='password' className='py-2 px-6 rounded-full text-black w-72 placeholder:text-sm' />
                <Clerk.FieldError className='text-red-300 text-sm' />
              </Clerk.Field>
              <div className='flex flex-col gap-2'>
                ...
                <SignIn.Action className='mt-2 text-sm underline w-72 text-center' navigate="forgot-password">Forgot password?</SignIn.Action>
              </div>
            </SignIn.Strategy>
          ...
          <p className='text-xs w-72'>By signing up, you agree to the <span className='text-iconBlue'>Terms of Service</span> and <span className='text-iconBlue'>Privacy Policy</span>, including <span className='text-iconBlue'>Cookie Use.</span></p>
        </SignIn.Root>
      </div>
    </div>
  )
